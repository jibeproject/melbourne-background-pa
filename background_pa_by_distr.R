...
set.seed(2026)
# Function to assign sports_PA from HSE data (calculated as total_PA - travel_PA)
# This ensures sports_PA is derived from df_B distribution
# assign_sports_PA <- function(df_A, df_B) {
#   df_A <- df_A |>
#     group_by(age_group, gender, imd) |>
#     mutate(
#       # Step 1: Draw total_PA from HSE (df_B) for given stratum
#       imputed_total_PA = {
...
#       },
#       
#       # Step 2: Calculate sports_PA as the difference (total_PA from HSE - travel_PA from synthetic)
#       sports_PA = imputed_total_PA - travel_PA,
#       
#       # Step 3: Maintain zero proportion from df_B - if imputed_total_PA is 0, set sports_PA to 0
#       sports_PA = if_else(imputed_total_PA == 0, 0, pmax(sports_PA, 0)),
#       
#       # Step 4: Reconstruct total_PA to ensure consistency
...
# Function to assign sports_PA from HSE data (calculated as total_PA - travel_PA)
# Uses quantile matching to ensure p25 and other quantiles align
# assign_sports_PA <- function(df_A, df_B) {
#   # Pre-compute the empirical CDF from df_B for quantile matching
#   df_B_total_PA <- df_B$total_PA
#   
#   df_A <- df_A |>
#     group_by(age_group, gender, imd) |>
#     mutate(
#       # Step 1: Generate uniform random values for quantile matching
#       u = runif(n()),
#       
#       # Step 2: Map to df_B quantiles using the empirical distribution
#       # This preserves the overall distribution of total_PA from df_B
#       imputed_total_PA = quantile(df_B_total_PA, probs = u, type = 7),
#       
#       # Step 3: Calculate sports_PA as the difference (total_PA from HSE - travel_PA from synthetic)
#       sports_PA = imputed_total_PA - travel_PA,
#       
#       # Step 4: Maintain zero proportion from df_B - if imputed_total_PA is 0, set sports_PA to 0
#       sports_PA = if_else(imputed_total_PA == 0, 0, pmax(sports_PA, 0)),
#       
#       # Step 5: Reconstruct total_PA to ensure consistency
#       total_PA = travel_PA + sports_PA,
#       
#       # Step 6: Remove temporary u column
#       u = NULL
#     ) |>
#     ungroup()
#   
...
# Sample sports_PA directly from df_B to preserve quantiles, then add travel_PA
# assign_sports_PA <- function(df_A, df_B) {
#   # Pre-compute sports_PA in df_B (total_PA - travel_PA equivalent concept)
#   # For HSE, we'll use the empirical distribution of total_PA as a proxy for sports_PA distribution
#   df_B_sports_PA <- df_B$total_PA  # HSE total_PA represents the overall PA distribution
#   
#   df_A <- df_A |>
#     mutate(
#       # Step 1: Generate uniform random values for quantile matching
...
#       
#       # Step 2: Map to df_B quantiles using the empirical distribution
#       # This directly samples the sports_PA distribution from df_B
#       sports_PA = quantile(df_B_sports_PA, probs = u, type = 7),
#       
#       # Step 3: Maintain zero proportion from df_B
#       sports_PA = if_else(sports_PA == 0, 0, pmax(sports_PA, 0)),
#       
#       # Step 4: Reconstruct total_PA as sum of travel_PA + sports_PA
#       total_PA = travel_PA + sports_PA,
#       
#       # Step 5: Remove temporary u column
#       u = NULL
#     )
#   
#   return(df_A)
...
# Function to assign sports_PA from HSE data
# Sample total_PA directly from df_B to preserve quantiles, then calculate sports_PA
# assign_sports_PA <- function(df_A, df_B) {
#   # Pre-compute the empirical distribution from df_B
#   df_B_total_PA <- sort(df_B$total_PA)
#   
#   df_A <- df_A |>
#     mutate(
#       # Step 1: Generate uniform random values for quantile matching
...
#       
#       # Step 2: Map to df_B quantiles using the empirical distribution
#       # This directly samples total_PA from df_B's distribution
#       total_PA = quantile(df_B_total_PA, probs = u, type = 7),
#       
#       # Step 3: Calculate sports_PA as the difference
#       sports_PA = total_PA - travel_PA,
#       
#       # Step 4: Maintain zero proportion from df_B
#       # If total_PA sampled from df_B is 0, set sports_PA to 0
#       sports_PA = if_else(total_PA == 0, 0, pmax(sports_PA, 0)),
#       
#       # Step 5: Remove temporary u column
#       u = NULL
#     )
